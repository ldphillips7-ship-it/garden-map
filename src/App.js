...
const gardenData = {
  ...
  "Section 8": ["Allium", "Catmint", "Weeping Japanese Maple", "Ornamental Grasses", "Vinca Bowles"],
  "Section 9": ["Ornamental Grasses", "Carex", "Stella d'Oro Daylily", "Liriope", "Vinca Bowles"],
  "Section 10": ["Spirea"],
